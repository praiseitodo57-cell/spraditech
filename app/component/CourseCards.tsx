...
import { Database, Users, MapPin, Code, Brain, Laptop, Shield, Palette, Cloud, Package, Video, Megaphone, Wifi, Bitcoin, Cog, Lock, Film             } from "lucide-react"
...
export default function CourseCards() {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 p-15 mt-20">
      ...
      <div className="flex  mt-9 gap-4 w-100 items-center justify-center ml-100">
              <button className="w-75 h-10 bg-blue-900 rounded-lg text-white text-lg ">View All Courses</button>
              <button className="w-75 h-10 border-2 border-blue-800 rounded-lg text-blue-900 text-sm font-bold bg-white">Schedule Consultation</button>
            </div>
          </div>
